...
import { creatArtist } from '../../../redux/slices/artists';
import { useDispatch } from "react-redux";

const AdminArtistCreate = () => {
    ...
    const handleClick = async (e) => {
        ...
        formData.append('artist_img', img)
                    ...
                    <div className='col-lg-6'>
                        <div className='my-5 py-5'>
                            <div className='d-flex justify-content-center aling-items-center h2 mb-5'>
                                Bagşy-sazandalar, artistler, türgenleri Goşmak
                            </div>
                            <form className='row'>
                                ...
                                <div className="col-lg-12 mb-3">
                                    ...
                                    <div className="input-group mb-3">
                                        <input name='artist_img' onChange={(e) => setImg(e.target.files[0])} type="file" className="form-control rounded-0" autoComplete="off" />
                                    </div>
                                </div>
...
export default AdminArtistCreate